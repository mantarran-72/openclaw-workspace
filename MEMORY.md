...
- As of 2026-07-16, wine industry work is very slow and Ethan is leaning back into construction/handyman work for income. He has been doing handyman work through Thumbtack and Taskrabbit and needs help getting more work and making more money. Treat construction/handyman revenue support as an active priority, not a side topic.
...
- Construction/handyman income support: practical help should focus on immediately usable lead generation, profile/offer optimization, pricing, job-type selection, follow-up scripts, local positioning, and ways to convert Ethan's GC/security/drone credibility into higher-ticket repair, inspection, documentation, and small-project work.
- Website business/domain direction: Ethan chose **Bay Area Design Lab** and bought `bayareadesignlab.com` on Vercel. Position the website offering broadly for any local business, not only trades. Trades/service businesses can be an initial wedge, but brand messaging should also fit restaurants, clinics, salons, consultants, nonprofits, and other local operators. Ethan is open to integrating AI into the name/positioning because customers are still curious about AI for business/work life and because it may later connect to his own AI assistant app. Use AI as a practical capability signal, not as the whole identity. Initial site should launch quickly as a credible one-page business site for websites, automation, and AI tools for local businesses.
- Bay Area Design Lab contact-flow baseline: keep it simple. `bayareadesignlab.com` form posts to Vercel `/api/contact`, which forwards to the Hermes `badl-contact` webhook, which delivers the lead to Ethan in Telegram. OpenClaw handles the Vercel/env side and Hermes handles notification delivery; extra local file-write or lead-script layers are unnecessary unless Ethan asks for a lead archive later.
- Bay Area Design Lab preview convention: client website previews should live under Ethan's domain, e.g. `https://www.bayareadesignlab.com/previews/<client-slug>`, like the Shelina Pabani preview. Avoid sending raw temporary ChatGPT/Sites preview URLs to prospects unless Ethan explicitly asks; publish or attach previews to Bay Area Design Lab first so the brand/domain supports the sales pitch.
- Pacific Houseworks / SF market direction: Ethan is considering a foothold in the San Francisco high-end handyman/home-services market while preserving credibility for larger construction/remodeling work. Recommended framing is not "handyman + remodeler" as equal labels; use an umbrella brand with two lanes: premium home services/small projects and construction/remodeling. Lead small work as "licensed, construction-grade home care / small projects by an experienced GC" rather than cheap handyman.
